...
function AbrirCarta(e) {
    ...
    // si las imagenes encontradas son las mismas que longitud hay ha ganado el juego
        if (imagenencontrada == imagenesdeportes.length) {
            ...
            mandarPuntos(score);
            $("#cajacartas").append('<span id="success">Enhorabuena has ganado '+score+' puntos <input class="button buttonsuccess" type="button" value="menu" id="volverAinicio"></input> </span>');
